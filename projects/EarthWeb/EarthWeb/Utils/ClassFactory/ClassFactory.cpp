...
FB::JSAPIPtr ClassFactory::createByEarthObjectClassType( int classType )
{
	...
	case EXTERNAL_FIRE:
		ptrJSAPI = boost::make_shared< ConstructorT< Fire > >();
		break;

	case EXTERNAL_LOCATION:
		ptrJSAPI = boost::make_shared< ConstructorT< Location > >();
		break;

	case ANNOTATION_TEXT_LABEL:
		ptrJSAPI = boost::make_shared< ConstructorT< TextLabel > >();
		break; 

	case ANNOTATION_MODEL:
		ptrJSAPI = boost::make_shared< ConstructorT< Model > >();
		break;

	case ANNOTATION_MODELSET:
		ptrJSAPI = boost::make_shared< ConstructorT< ModelSet > >();
		break;
	...
	case GEODATA_LINE:
		ptrJSAPI = boost::make_shared< ConstructorT< GeoLine > >();
		break;

	case GEODATA_POLYGON:
		ptrJSAPI = boost::make_shared< ConstructorT< GeoPolygon > >();
		break;

	case GEODATA_FEATURE:
		ptrJSAPI = boost::make_shared< ConstructorT< GeoFeature > >();
		break;

	case ANNOTATION_FEATURE:
		ptrJSAPI = boost::make_shared< ConstructorT< FeaturePrimitive > >();
		break;

	case ANNOTATION_CIRCLE:
		ptrJSAPI = boost::make_shared< ConstructorT< Circle > >();
		break;
...
FB::JSAPIPtr ClassFactory::createBySourceClassType( int classType )
{
	...
	case TILE_SOURCE_PGIS:
		ptrJSAPI = boost::make_shared< ConstructorT< TileSourcePGIS > >();
		break;

	case TILE_SOURCE_QS:
		ptrJSAPI = boost::make_shared< ConstructorT< TileSourceQS > >();
		break;
