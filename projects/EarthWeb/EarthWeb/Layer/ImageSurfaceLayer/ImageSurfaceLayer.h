...
public:
		...
		ImageSurfaceLayerDispatchImpl( IMAGE_SURFACE_LAYER )
	{
		...
		registerProperty("visible", make_property(this, &ImageSurfaceLayer::get_visible, &ImageSurfaceLayer::put_visible));
		registerProperty( "tileSource", make_property( this, &ImageSurfaceLayer::get_tileSource, &ImageSurfaceLayer::put_tileSource ) );
		registerProperty("opacity", make_property(this, &ImageSurfaceLayer::get_opacity, &ImageSurfaceLayer::put_opacity));
	}
